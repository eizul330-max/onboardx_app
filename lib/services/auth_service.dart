...
class AuthService {
  ...
  String get backendBaseUrl {
    if (kIsWeb) {
      return "http://10.111.132.36:4000/api";
    } else {
      // Untuk emulator Android gunakan 10.0.2.2, untuk iOS gunakan localhost
  ...
  Future<bool> syncUserProfile(
    ...
    try {
      ...
      print('syncUserProfile status: ${resp.statusCode}');
      print('syncUserProfile body: ${resp.body}');
