...
class _UserDetailScreenState extends State<UserDetailScreen> {
          ...
          children: [
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  Text(
                    _fullName.isNotEmpty ? _fullName : (AppLocalizations.of(context)!.noName),
  ...
  Widget _infoRow({required IconData icon, required String label, required String value, VoidCallback? onTap, VoidCallback? onCopy}) {
    return ListTile(
      ...
      subtitle: value.isNotEmpty ? Text(value) : Text((AppLocalizations.of(context)!.notspecified)),
      trailing: Row(
      ...
      children: [
        Expanded(
          child: ElevatedButton.icon(
            ...
            label: _savingContact ? Text((AppLocalizations.of(context)!.saving)) : const Text('Save to Phone'),
          ...
          children: [
            if (widget.userData['uid'] != null)
              ListTile(
                ...
                title: Text((AppLocalizations.of(context)!.openinApp)),
                subtitle: Text((AppLocalizations.of(context)!.viewfullprofileinsideapp)),
                onTap: _openInAppProfile,
              ),
            ListTile(
              leading: const Icon(Icons.share),
              title: Text((AppLocalizations.of(context)!.shareContact)),
              subtitle: Text((AppLocalizations.of(context)!.sharevcardtextorsimpleinfo)),
              onTap: () {
